...
<head>
  ...
  <title>Uniformes Masculino Limpeza</title>
  <style>
    body {
...
<?php include_once("heade.php");?>
  <header></header>
    <div class="principal">
        ...
        <p>Nossos uniformes oferecem conforto e praticidade, garantindo que os homens possam desempenhar suas funções de limpeza com eficiência, sem comprometer o estilo.</p>
      </div>
    </header>
    <body>
