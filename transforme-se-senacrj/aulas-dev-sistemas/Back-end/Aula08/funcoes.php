...
// Tópico 1: Introdução às Funções em PHP

// *Conteúdo Teórico:*
// - Funções são blocos de código que podem ser reutilizados.
// - São úteis para evitar repetição de código.
// - Permitem que você agrupe um conjunto de instruções em uma única unidade.
...
// Tópico 2: Parâmetros em Funções

// *Conteúdo Teórico:*
// - Parâmetros são valores que uma função recebe.
// - Eles são usados para passar informações para dentro da função.
// - Parâmetros são declarados na definição da função.
// - Você pode usar esses valores dentro da função.
...
echo "O quadrado é $resultado \n"; // Saída: O quadrado de 4 é 16
...
// cumprimento("Alice"); // Saída: Olá, Alice!
