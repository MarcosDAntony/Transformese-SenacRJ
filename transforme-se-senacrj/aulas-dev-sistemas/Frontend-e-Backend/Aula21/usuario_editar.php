            ...
            <div class="col-md-6">
                <form action="Usuario.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" value="<?= $usuario['Nome'] ?>" required <?= " $desabilitado" ?> >
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email:</label>
                        <input type="email" class="form-control" id="email" name="email" value="<?= $usuario['Email'] ?>" required <?= " $desabilitado" ?> >
                    </div>
                    <div class="mb-3">
                        <label for="data_cadastro" class="form-label">Data Cadastro:</label>
                        <input type="date" class="form-control" id="data_cadastro" name="data_cadastro" placeholder="YYYY-MM-DD" value="<?= $usuario['DataCadastro'] ?>" required <?= " $desabilitado" ?> >
                    </div>
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="situacao" name="situacao" value="1" <?= $usuario['Situacao'] == 1 ? 'checked' : '' ?> <?= " $desabilitado" ?>>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3 col-3">
                        ...
                        <img src="<?= isset($usuario['Foto']) ? $usuario['Foto'] : 'img/userpadrao.png' ?>" alt="Preview da Foto" id="foto_preview" name="foto_preview" class="img-fluid w-251 h-251 border">
                    </div>
                </div>
                <div class="row my-3">
                    <div class="col-md-6 ">
