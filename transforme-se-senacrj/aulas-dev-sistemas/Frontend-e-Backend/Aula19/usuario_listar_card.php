...
<body>
   ...
   <?php include_once("header.php"); ?>
                    ...
                    foreach ($usuarios as $index => $usuario) {
                     echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='usuario.php?acao=excluir&id=" . ($index + 1) . "' class='btn btn-danger btn-sm'>
    ...
    <?php foreach ($usuarios as $index => $usuario): ?>
            <div class="col-md-3">
                        <a href="usuario_editar.php?id= <?=$usuario['id_usuario']?> " class="btn btn-primary">
                        <img src=<?= $usuario['Foto']?> class="card-img-top shadow">
                        </a>
                    </div>
                <?php endforeach; ?>
    </div>
