...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: usuario_listar.php?mensagem=Usuario+cadastrado+com+sucesso");
    exit();
     ...
     switch ($acao) {
         case 'excluir':
             ...
             if ($indice_usuario != -1) {
                 ...
                 header("Location: usuario_listar.php?mensagem=Usuario+excluido+com+sucesso");
                 exit();
             } else {
        ...
        default:
            // Ação desconhecida
            header("Location: usuario_listar.php?mensagem=Acao+desconhecida");
            exit();
    }
} else {
