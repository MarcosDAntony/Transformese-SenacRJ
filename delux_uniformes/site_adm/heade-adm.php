            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav flex-grow-1 pe-3" style="font-size: 17px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="area-adm.php">
                              <img src="../site_adm/conteudos/imagens/icons/atual/contdeadm.png" style="height:20px; width:20px;" alt="contadeadm" >
                            </a>
                        </li>
                    ...
                    <div class="divBusca posicao-pesquisa">
                        ...
                        <a href="#Pesquisa" target="_top" class="animate-img"><img src="../site_adm/conteudos/imagens/icons/atual/lupa2-2.png" style="height:25px; width:25px;" /></a>
                    </div>
                </div>
            </div>
        </div>
